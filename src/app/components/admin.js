          ...
          <tbody>
            ${users.map(user => html`
              <tr>
                ...
                <td style="border: 1px solid #ddd; padding: 8px;">
                  <form method="post" action="/admin/user/role" style="margin: 0;">
                    <input type="hidden" name="userId" value="${user.id}" />
                    <select name="role" onchange="this.form.submit()" style="padding: 4px; border: 1px solid #ccc; border-radius: 3px;">
